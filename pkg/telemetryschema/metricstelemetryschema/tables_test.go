...
func TestInit(t *testing.T) {
	dbName = ""
	Init("custom_metrics_db")
	assert.Equal(t, "custom_metrics_db", dbName)
}
...
func TestDBNameAfterInit(t *testing.T) {
	dbName = ""
	Init("my_custom_metrics")
	assert.Equal(t, "my_custom_metrics", DBName())
}

func TestDBNameDefault(t *testing.T) {
	dbName = ""
	assert.Equal(t, "signoz_metrics", DBName())
}
