...
ORDER BY
    resource_string_service$$name;
`, tracestelemetryschema.DBName(), start, end, tsBucketStart, tsBucketEnd, queueType, topic, partition, consumerGroup, timeRange)
	return query
}
...
ORDER BY
    topic;
`, tracestelemetryschema.DBName(), start, end, tsBucketStart, tsBucketEnd, queueType, timeRange)
	return query
}
...
ORDER BY
    consumer_group;
`, tracestelemetryschema.DBName(), start, end, tsBucketStart, tsBucketEnd, queueType, topic, partition, timeRange)
	return query
}
...
FROM
    consumer_latency
`, tracestelemetryschema.DBName(), start, end, tsBucketStart, tsBucketEnd, service, queueType, topic, timeRange)
	return query
}
...
ORDER BY
    topic;
`, tracestelemetryschema.DBName(), start, end, tsBucketStart, tsBucketEnd, queueType, timeRange, timeRange)
	return query
}
...
GROUP BY
    producer_service,
    consumer_service
`, tracestelemetryschema.DBName(), tracestelemetryschema.DBName(), start, end, start, end, queueType, queueType, evalTime, evalTime)
	return query
}
...
`, timeRange, tracestelemetryschema.DBName(), start, end, tsBucketStart, tsBucketEnd, queueType, consumerGroup, partitionID)
	return query
}
...
WHERE
    ...
    AND timestamp <= '%d'
    AND ts_bucket_start >=  '%d'
    AND ts_bucket_start <= '%d';`, queueType, tracestelemetryschema.DBName(), start, end, tsBucketStart, tsBucketEnd)
	return query
}
